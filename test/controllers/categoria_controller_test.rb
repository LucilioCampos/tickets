...
class CategoriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categorium" do
    assert_difference('Categorium.count') do
      post categoria_url, params: { categorium: { categoriaKey: @categorium.categoriaKey, cor: @categorium.cor, descricao: @categorium.descricao } }, as: :json
    end
  ...
  test "should update categorium" do
    patch categorium_url(@categorium), params: { categorium: { categoriaKey: @categorium.categoriaKey, cor: @categorium.cor, descricao: @categorium.descricao } }, as: :json
    assert_response 200
  end
